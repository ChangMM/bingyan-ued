...
Indentation = (function(superClass) {
  ...
  Indentation.prototype.indentBlock = function(blockEl) {
    var $blockEl, $childList, $nextTd, $nextTr, $parentLi, $pre, $td, $tr, marginLeft, textIndent, tagName;
    $blockEl = $(blockEl);
    if (!$blockEl.length) {
      return;
    }
    if ($blockEl.is('pre')) {
      ...
      textIndent = parseInt($blockEl.css('text-indent'))/parseInt($blockEl.css('font-size')) || 0;
      textIndent = (Math.round(textIndent / 2) + 1) * 2;
      $blockEl.css('text-indent', textIndent + 'em');
  ...
  Indentation.prototype.outdentBlock = function(blockEl) {
    var $blockEl, $parent, $parentLi, $pre, $prevTd, $prevTr, $td, $tr, marginLeft, textIndent, range;
    $blockEl = $(blockEl);
    ...
    if ($blockEl.is('pre')) {
      ...
      textIndent = parseInt($blockEl.css('text-indent'))/parseInt($blockEl.css('font-size')) || 0;
      textIndent = Math.max(Math.round(textIndent / 2) - 1, 0) * 2;
      $blockEl.css('text-indent', textIndent === 0 ? '' : textIndent + 'em');
    } else if ($blockEl.is('table') || $blockEl.is('.simditor-table')) {
      $td = this.editor.selection.containerNode().closest('td, th');
